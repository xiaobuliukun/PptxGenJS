...
const EMBEDDED_FONT_FACE_XML: Record<EmbeddedFontFaceName, string> = {
	regular: 'regular',
	bold: 'bold',
	italic: 'italic',
...
export function makeXmlContTypes (slides: PresSlide[], slideLayouts: SlideLayout[], masterSlide?: PresSlide, embeddedFonts: EmbeddedFont[] = []): string {
	...
	if (embeddedFonts.length > 0) strXml += '<Default Extension="ttf" ContentType="application/x-font-ttf"/>'
...
function makeXmlEmbeddedFonts (embeddedFonts: EmbeddedFont[]): string {
